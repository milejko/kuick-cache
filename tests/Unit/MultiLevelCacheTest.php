...
use Kuick\Cache\MultiLevelCache;
...
/**
 * @covers \Kuick\Cache\MultiLevelCache
 */
class MultiLevelCacheTest extends TestCase
{
    public function testIfCacheCanBeSetAndGet(): void
    {
        $cache = new MultiLevelCache(
            [
                $firstArrayCache = new ArrayCache(),
                $secondArrayCache = new ArrayCache(),
            ]
        );
